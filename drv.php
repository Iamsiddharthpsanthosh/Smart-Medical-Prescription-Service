...
if (isset($_POST["patientid"])) {
    ...
    $stmt = $connect->prepare("SELECT * FROM registernewpatient WHERE patientid = ?");
...
<div class="panel-body">
            <form action="connect3.php" method="post">
              <div class="form-group  ol-md-6 col-md-offset-3">
		      <label  for="drugs">
                        <h3>Drugs:</h3>
                      </label>
              <textarea rows="5" cols="80" id="TITLE" id="drugs" name="drugs"></textarea> 
              </div>
		      ...
		      <label  for="details">
               ...
               <textarea class="area2" rows="5" cols="80" id="details" name="details"></textarea> 
              </div>
   <label  for="patientid">
                        <h3>Patients id:</h3>
                      </label>
                <input type="text" size="4" class="form-control" id="patientid" name="patientid"/>
